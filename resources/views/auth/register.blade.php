...
<div class="bg-white rounded-3xl shadow-xl p-8 border border-violet-100">
    <h1 class="font-app-heading text-2xl font-bold text-gray-800 text-center mb-1">¡Crea tu cuenta! ✨</h1>
    <p class="text-center text-gray-500 text-sm mb-7">Gratis · Sin tarjeta · En segundos</p>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-4">
        ...
        <div>
            ...
            <input type="text" name="name" value="{{ old('name') }}" required
                   class="w-full px-4 py-3 rounded-xl border @error('name') border-red-400 @else border-gray-200 @enderror focus:outline-none focus:ring-2 focus:ring-violet-400 transition"
        ...
        <div>
            ...
            <input type="password" name="password" required
                   class="w-full px-4 py-3 rounded-xl border @error('password') border-red-400 @else border-gray-200 @enderror focus:outline-none focus:ring-2 focus:ring-violet-400 transition"
    ...
    <p class="text-center text-sm text-gray-500 mt-6">
        ¿Ya tienes cuenta?
        <a href="{{ route('login') }}" class="text-violet-600 font-semibold hover:underline">Inicia sesión</a>
    </p>
</div>
@endsection
